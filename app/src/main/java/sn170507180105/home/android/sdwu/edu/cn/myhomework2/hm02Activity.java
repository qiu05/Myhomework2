...
public class hm02Activity extends AppCompatActivity {
    ...
    public void insert(View view){
        ...
        try{
            ...
            Log.e(hm02Activity.class.toString(),e.toString());
        }finally {
    ...
    public void show(View view){
        ...
        try{
            ...
            while (cursor.moveToNext()){
                ...
                Log.i(hm02Activity.class.toString(),"id:"+id+",name:"+name+",age:"+age+",height:"+height);
            }
            cursor.close();//游标关闭
        }catch (Exception e){
            Log.e(hm02Activity.class.toString(),e.toString());
